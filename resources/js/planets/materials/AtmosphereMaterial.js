...
export function createAtmosphereMaterial(
  ...
  const uniforms = {
    lightDirection: {
      value: (lightDirection ?? new THREE.Vector3(1.0, 1.0, 0.0)).normalize(),
    },
    atmosphereColor: { value: color ?? new THREE.Vector3(0.3, 0.6, 1.0) },
  };
  ...
  return new THREE.ShaderMaterial(atmosphereShader);
} 